...
<body>
    ...
    <div class="container">		
        ...
        <?php 
            ...
            // http://Localhost/board/board.php?page=-3
            if($currentPage <1 ) 
                $currentPage = 1;
        ...
        <?php
            ...
            /* select * from board order by regtime limit start_record, count
        ...
        <?php if($totalCount>0) : ?> 
            ...
            <?php if($startPage>1) : ?>
                <a href='<?=combineUrl("board.php",0,$currentPage-NUM_PAGE_LINKS)?>' ><</a>&nbsp;
            <?php endif?>
            ...
            <?php if($endPage<$totalPage) : ?>
                <a href="<?=combineUrl('board.php',0,$startPage+NUM_PAGE_LINKS)?>">></a>
            <?php endif ?>
